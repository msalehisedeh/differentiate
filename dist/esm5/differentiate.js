...
var DifferentiateComponent = /** @class */ (function () {
    ...
    DifferentiateComponent.prototype.performAdvanceToRight = function (leftSideInfo, rightSideInfo, status, index) {
        var _this = this;
        var modifiedChildren = this.leftSide[0].children[index].children;
        ...
        setTimeout(function () {
            _this.onadvance.emit(_this.transformNodeToOriginalStructure(modifiedChildren, DifferentiateNodeType.json));
            _this.fireCountDifference();
        }, 66);
    };
    DifferentiateComponent.prototype.performAdvanceToLeft = function (leftSideInfo, rightSideInfo, status, index) {
        var _this = this;
        var modifiedChildren = this.rightSide[0].children[index].children;
        ...
        setTimeout(function () {
            _this.onrevert.emit(_this.transformNodeToOriginalStructure(modifiedChildren, DifferentiateNodeType.json));
            _this.fireCountDifference();
        }, 66);
    };
